...
**HV-MCP Server** — Any MCP server that implements this specification. ProofTwin is the reference HV-MCP server.

**HV-MCP Client** — Any MCP client that connects to an HV-MCP server. AgenTwin is the reference HV-MCP client.
...
│                    PROOF PROTOCOL SUT                   │
│                                                         │
│  ACR ──[HV-MCP Session Control]──▶ PROOFTWIN           │
│                                         │               │
│  AGENTWIN ──[HV-MCP Client]──▶ PROOFTWIN               │
│                                         │               │
│                           PROOFTWIN ──[HV-MCP Proxy]──▶ ASC │
│                                         │               │
...
## 5. HV-MCP Session Control Interface (ACR → ProofTwin)
...
## 6. HV-MCP Client Interface (AgenTwin → ProofTwin)
...
## 7. HV-MCP Proxy Interface (ProofTwin → ASC)
...
A component claiming HV-MCP compatibility MUST:
...
HV-MCP is versioned independently of ProofTwin and other PP-SPEC documents. Interface changes that break compatibility increment the major version. Additive changes increment the minor version.

Current version: `HV-MCP/1.0`

All HV-MCP messages MUST include a version field:
...
| Reference ProofTwin implements HV-MCP/1.0 | 2026-08-01 |
| First third-party ASC certified via HV-MCP | 2026-09-01 |
| HV-MCP/1.0 stable | 2026-09-01 |
